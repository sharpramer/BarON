...
export default function TermosUtilizacao() {
  return (
    <ScrollView style={estilosTermosUtilizacao.conteiner}>
      <View style={estilosTermosUtilizacao.conteudo}>
        ...
        <Text style={estilosTermosUtilizacao.paragrafo}>
          ...
          "A empresa" refere-se à CELEGHINI COMERCIO E ALIMENTACAO LTDA, 
          com o CNPJ 10.333.851/0001-00, 
          com sede na Avenida Diario de Noticias, 300 - Cristal, Porto Alegre - RS, 90.810-080.
        </Text>
        ...
        <Text style={estilosTermosUtilizacao.paragrafo}>
          ...
          <Text style={{ fontWeight: 'bold' }}>
            {''} estritamente permitido apenas para maiores de 18 anos
          </Text>.
        </Text>
        <Text style={estilosTermosUtilizacao.paragrafo}>
          Caso seja identificado que um usuário menor de idade criou uma conta, 
          essa conta será suspensa ou excluída imediatamente.
        </Text>

        <Text style={estilosTermosUtilizacao.subtitulo}>3. Cadastro e Segurança da Conta</Text>
        <Text style={estilosTermosUtilizacao.paragrafo}>
          O usuário é responsável por manter a confidencialidade de suas credenciais de acesso e não deve 
